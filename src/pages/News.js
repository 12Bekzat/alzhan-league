...
export default function NewsPage() {
  ...
  const posts = [
    ...
    },
    {
      ...
      is_video: true,
      caption:
        "Задали несколько вопросов нашим юным баскетболисткам и болельщицам ⚡️",
    ...
    },
    {
      ...
      is_video: true,
      caption:
        "Напряженные игры, радость побед и горячая поддержка трибун – суперфинал Alzhan в Хромтау подарил сотни незабываемых моментов.\n\n🏀 Смотрите, как команды боролись за звание сильнейших!",
