  ...
  return (
    ...
    >
      ...
      <div style={{ zIndex: 2, maxWidth: "800px", padding: "0 20px" }}>
        ...
        >
          Школьная баскетбольная лига «Alzhan» стартовала в 2024 году и за
          второй сезон выросла до более чем 2000 участников — это быстрый,
          устойчивый рост, подтверждающий востребованность проекта
        </p>
      </div>
    </div>
  );
